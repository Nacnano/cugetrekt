      ...
      <div className="container-fluid bg-sd text-white d-flex align-items-center justify-content-center">
        <footer className="py-3 mt-4">
          ...
          <ul className="nav justify-content-center pb-3 border-top">
            ...
            <li className="nav-item"><Link to="/MyDocuments" className="text-white nav-link px-2">ถอน</Link></li>
            <li className="nav-item"><Link to="/MyDocuments" className="text-white nav-link px-2">ลาออก</Link></li>
