      ...
      <main style={{ marginTop: "5em" }}>
        <div className="container">
            ...
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
                ...
                <p className="fs-4 mb-0">
                  ...
                  คุณสามารถส่งเอกสารให้กับอาจารย์ที่ปรึกษาทางอีเมล์หรือจะพิมพ์ออกมา
              ...
              <div>
                ...
                <p className="fs-4 mb-0">
                  <span className="text-rgb">
                    ยินดีด้วย!! คุณลาออกสำเร็จแล้ว!!
                  </span>{" "}
                  ตอนนี้คุณก็แค่นั่งรอผลการลาออกในเว็ปไซต์{" "}
                  <a className="fw-bold" href="https://www2.reg.chula.ac.th">
                    Reg Chula
                  </a>{" "}
                  หลัง 5 วันทำการก็เป็นอันเสร็จสิ้น!! 🎉🎉
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row mb-3">
            <div className="col d-flex ps-0 align-items-center justify-content-center">
              <div>
                <Link to="/" className="my-auto p-2 btn btn-danger btn-lg">
                  กลับไปหน้าหลัก
                </Link>
              </div>
            </div>
