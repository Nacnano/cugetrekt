        ...
        <div className="container">
          <div className="row">
            <div className="col text-center">
              ...
              <h1 className="display-2 color-sd fw-bold">ยินดีด้วย!! คุณถอน<span className="text-decoration-underline">เกือบ</span>เสร็จแล้ว!!</h1>
          ...
          <div className="row py-2">
            ...
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
                <h1 className="color-sd fw-bold">ส่งคำร้องถอนใน reg.chula.ac.th</h1>
                <p className="fs-4 mb-0"> เพียงแค่ล็อกอินเข้าไปใน <a className="fw-bold" href="https://www2.reg.chula.ac.th">Reg Chula</a> แล้วเลือกเมนู <b>"แสดงความจำนงขอถอนรายวิชา"</b> และเลือกวิชาที่ต้องการถอนให้ตรงกับวิชาที่กรอกไว้</p>
                <a className="btn btn-danger mt-2" href="" role="button">Reg Chula</a>
              </div>
            </div>
          </div>
          <hr />
          <div className="row py-2">
            ...
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
                <h1 className="color-sd fw-bold">ส่งเอกสารให้อาจารย์ประจำวิชา</h1>
                <p className="fs-4 mb-0"> หลังจากที่คุณดาวน์โหลดเอกสารแล้ว คุณสามารถส่งเอกสารให้กับอาจารย์ประจำวิชาทางอีเมล์หรือจะพิมพ์ออกมา แล้วนำไปให้อาจารย์เซ็นก็ได้เช่นเดียวกัน!!</p>
              </div>
            </div>
          </div>
          <hr />
          <div className="row py-2">
            ...
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
                ...
                <p className="fs-4 mb-0"> เช่นเดียวกันกับอาจารย์ประจำวิชา คุณสามารถส่งเอกสารให้กับอาจารย์ที่ปรึกษาทางอีเมล์หรือจะพิมพ์ออกมาก็ได้!!</p>
              </div>
            </div>
          </div>
          <hr />
          <div className="row py-2">
            <div className="col-3 d-flex align-items-center justify-content-center">
              <h1 className="text-center color-sd fw-bold mb-0" style={{ fontSize: 125 }}>4</h1>
            </div>
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
          ...
          <div className="row py-2">
            <div className="col-3 d-flex align-items-center justify-content-center">
              <h1 className="text-center color-sd fw-bold mb-0" style={{ fontSize: 125 }}>5</h1>
            </div>
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
                <h1 className="color-sd fw-bold">รอผลการถอน</h1>
                <p className="fs-4 mb-0"><span className="text-rgb">ยินดีด้วย!! คุณถอนสำเร็จแล้ว!!</span> ตอนนี้คณก็แค่นั่งรอผลการถอนในเว็ปไซต์ <a className="fw-bold" href="https://www2.reg.chula.ac.th">Reg Chula</a> ภายใต้หัวข้อ “ผลการลงทะเบียนเรียน" ก็เป็นอันเสร็จสิ้น!! 🎉🎉</p>
              </div>
            </div>
          </div>
          <hr />
