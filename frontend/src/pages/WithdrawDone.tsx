          ...
          <div className="row py-2">
            ...
            <div className="col-9 d-flex ps-0 align-items-center">
              <div>
                ...
                <p className="fs-4 mb-0"><span className="text-rgb">ยินดีด้วย!! คุณถอนสำเร็จแล้ว!!</span> ตอนนี้คณก็แค่นั่งรอผลการถอนในเว็ปไซต์ Reg Chula ภายใต้หัวข้อ “ผลการลงทะเบียนเรียน" ก็เป็นอันเสร็จสิ้น!! 🎉🎉</p>
              </div>
            </div>
          </div>
          <hr />
